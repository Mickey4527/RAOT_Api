...
Revision ID: 9ea458259ab3
Revises: 
Create Date: 2024-12-30 09:33:27.535916
...
def upgrade() -> None:
    ...
    sa.Column('permission_description', sa.String(length=255), nullable=False),
